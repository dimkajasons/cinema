...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(12), __webpack_require__(11)(module)))
...
// CONCATENATED MODULE: ./models/collectionModule.js
...
// CONCATENATED MODULE: ./Films/movieCollectionModule.js
...
// }
// ];
class movieCollectionModule_MovieCollection extends Collection {
    constructor(options) {
        super(options);
    }
    fetch(lastChild) {
        ...
        return Promise.resolve(axios_default.a.get('/api/movies?lastChild='+lastChild).then((result) => {
...
/* harmony default export */ var movieCollectionModule = (movieCollectionModule_MovieCollection);
// CONCATENATED MODULE: ./models/modelModule.js
class Model {
    constructor(options) {
        //this._id = generateId();
...
// CONCATENATED MODULE: ./Films/movieModelModule.js

class movieModelModule_MovieModel extends Model {
    constructor(options) {
        super (options);
    }
    setTitle(title) {
...
// CONCATENATED MODULE: ./models/viewModule.js
class View {
...
// CONCATENATED MODULE: ./utils/image-utils.js
...
/* harmony default export */ var image_utils = (loadImage);
// EXTERNAL MODULE: ./node_modules/lodash/lodash.js
var lodash = __webpack_require__(1);
var lodash_default = /*#__PURE__*/__webpack_require__.n(lodash);

// CONCATENATED MODULE: ./templates/templates.js
// var dateAction = {
...
// CONCATENATED MODULE: ./utils/dateTransformModule.js
var dateAction = {
    dateTransform: function (date) {
        let days = ['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'];
        let months = ['January', 'February', 'March', 'April', 'May',
...
// CONCATENATED MODULE: ./Films/movieViewModule.js





class movieViewModule_MovieView extends View {
    constructor(options) {
        super(options);
        this.collection = options.collection;
    }
    render() {
        var renderWithParams = lodash_default.a.template(templates.movieHTML);
        ...
        image_utils(this.model.img_src).then((img) => {
...
// CONCATENATED MODULE: ./jqueryEvent.js
...
function dynamicLoader(elem) {
    ...
    jqueryEvent_lastChild = document.querySelector('#movie-list').childElementCount;
    // alert(5)
    // currentChildQuantity = document.querySelector('#movie-list').childElementCount;
    if (!exit) {
        if ($win.scrollTop() + $win.height() >= jquery_default()(elem).offset().top) {
            document.querySelector('.load-marker').classList.remove('load-marker');
            document.querySelector('#movie-list').children[jqueryEvent_lastChild - 2].classList.add('load-marker');


            moviesCollection.fetch(jqueryEvent_lastChild).then(function (result) {
                if (result.length === 0){
                    exit = true;
                }
                let movieListView = new movieListViewModule_MovieListView({
                    el: document.querySelector('#movie-list'),
                    className: 'list-container',
                    collection: moviesCollection,
                    children: result.map(function (movie) {
                        return new movieViewModule_MovieView({
                            model: movie,
...
/* harmony default export */ var jqueryEvent = (dynamicLoader);
// CONCATENATED MODULE: ./Films/movieListViewModule.js





class movieListViewModule_MovieListView extends View {
    constructor(options) {
        super(options);
        this.collection = options.collection;
        ...
        document.querySelector('#add-movie-button').addEventListener('click', function (e) {
            this.collection.create({
                ...
                "director": "Zemekis",
                "year": 2018
            }).then((movie) => this.addMovie(new movieViewModule_MovieView({
                model: movie,
                className: "movie-item",
    ...
    addLoadMarker() {
        ...
        let throttled = lodash_default.a.throttle(() => jqueryEvent(document.querySelector('.load-marker')), 5000);
        document.addEventListener('scroll', function (e) {
            throttled();
        });
    }
...
// CONCATENATED MODULE: ./Sessions/sessionCollectionModule.js
...
class sessionCollectionModule_SessionCollection extends Collection {
    constructor(options) {
        super(options);
    }
    fetch() {
        return Promise.resolve(axios_default.a.get('/api/sessions')).then((result) => {
            //2
            this.children = result.data.map((element) => {
                return new this.Model(element)
            });
...
// CONCATENATED MODULE: ./Sessions/sessionModelModule.js

class sessionModelModule_SessionModel extends Model {
    constructor(options) {
        super(options);
    }
}
// CONCATENATED MODULE: ./Sessions/sessionViewModule.js



class sessionViewModule_SessionView extends View {
    constructor(options) {
        super(options);
...
// CONCATENATED MODULE: ./Sessions/sessionListViewModule.js

class sessionListViewModule_SessionsListView extends View {
    constructor(options) {
        super(options)
        this.children = options.children || [];
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "moviesCollection", function() { return moviesCollection; });
...
let moviesCollection = new movieCollectionModule({
    model: movieModelModule_MovieModel,
    url: 'filmsData.json'
});
...
let sessionCollection = new sessionCollectionModule_SessionCollection({
    model: sessionModelModule_SessionModel,
    url: 'sessionData.json'
});

sessionCollection.fetch().then((result) => {
    let sessionListView = new sessionListViewModule_SessionsListView({
        el: document.querySelector("#session-list"),
        children: result.map(function (session) {
            return new sessionViewModule_SessionView({
                model: session,
